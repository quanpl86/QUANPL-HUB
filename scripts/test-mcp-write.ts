...
async function runTests() {
  ...
  const baseDraft = {
    ...
    featured_image: {
      ...
      alt: "Test cover",
      url: "https://raw.githubusercontent.com/quanpl86/imgBlog/main/public/editor-assets/test-cover.png",
    },
    featured_image_url: "https://raw.githubusercontent.com/quanpl86/imgBlog/main/public/editor-assets/test-cover.png",
    inline_images: [
      {
        id: "img-01",
        purpose: "workflow",
