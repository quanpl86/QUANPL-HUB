export const CHATGPT_MCP_PERMISSIONS = {
  ...
  allow: [
    "upload_generated_image_file — nhận native ChatGPT file param (download_url + file_id), QA và lưu PNG gốc lên GitHub",
  ...
  deny: [
    "gọi start_image_upload từ ChatGPT; tool này chỉ dành cho external client có HTTP binary upload",
    "publish / đăng bài",
