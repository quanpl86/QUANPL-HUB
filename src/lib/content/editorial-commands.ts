export const EDITORIAL_COMMANDS = {
  ...
  commands: [
    ...
    },
    {
      ...
      do: [
        "Nếu user muốn ảnh đẹp nhất: tạo bằng ChatGPT Images trong chat này, rồi generate_and_upload_blog_image source_url",
        "Nếu user muốn Hub tự gắn bài: generate_and_upload_blog_image, MCP chọn OpenAI Images trước, không tự pick FLUX",
        "Rubric/workflow/timeline/bảng: required_labels + layout_spec, SVG exact text",
        "Gắn URL MỚI. Không tái sử dụng URL cũ.",
      ],
      never: ["publish"],
    },
    {
