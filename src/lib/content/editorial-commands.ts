  ...
  commands: [
    ...
    },
    {
      ...
      do: [
        ...
        "revise[]: xem command fix_rejected_draft",
      ],
    ...
    },
    {
      ...
      do: [
        "get_due_editorial_slots và get_editorial_week",
        "revise[] hoặc slot revision_requested có result_post_id",
        "Đọc comments, update_blog_draft(calendar_id)",
        "Không tạo bài mới",
      ],
