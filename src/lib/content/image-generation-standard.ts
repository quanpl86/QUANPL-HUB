export const IMAGE_GENERATION_STANDARD = {
  version: "1.4",
  rule: "Scenes (cover + body): ChatGPT Images IN THIS CHAT, then start_image_upload POST put_url. generate_and_upload_blog_image is SVG-only for Vietnamese structured labels. Hub OpenAI API is not ChatGPT Plus Images. Never compress/downscale to fit a tool call.",
  quality: {
    cover_min: "1536x864",
    inline_min: "1280x720",
  ...
  agent_must: [
    ...
    "Do not call generate_and_upload_blog_image for cover/scene. That is not ChatGPT Plus Images.",
    "Cover: 16:9, no text.",
