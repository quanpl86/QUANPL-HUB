    ...
    <div className="max-w-4xl">
      <div className="mb-10">
        ...
        <p className="font-mono text-brand-orange text-xs uppercase tracking-widest font-bold">
          {'// MÔ-ĐUN_ĐỊNH_NGHĨA_MIỀN_TOÀN_CẦU //'}
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <StaticCyberCard className="p-6 h-fit border-brand-orange/25">
          <h2 className="font-orbitron font-bold text-sm mb-6 border-b border-brand-orange/35 pb-2 uppercase tracking-widest">Định Nghĩa Lĩnh Vực Mới</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          {fields?.map((field) => (
            <div key={field.id} className="group relative bg-cyber-black/5 dark:bg-cyber-black/40 border border-brand-orange/25 p-4 hover:border-brand-orange/60 transition-all flex justify-between items-start cyber-cut-sm">
              <div>
