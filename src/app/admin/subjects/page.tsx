  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-10">
        ...
        <p className="font-mono text-muted text-xs uppercase tracking-widest">// MÔ-ĐUN_ĐỊNH_NGHĨA_KỶ_LUẬT //</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <StaticCyberCard className="p-6 h-fit">
          <h2 className="font-orbitron font-bold text-sm mb-6 border-b border-brand-orange/20 pb-2 uppercase tracking-widest">Đăng Ký Chủ Đề Mới</h2>
